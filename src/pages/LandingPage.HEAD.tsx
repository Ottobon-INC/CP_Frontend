...
const HERO_VARIANTS: Record<string, HeroVariant> = {
  A: {
    ...
    highlight: "Still CanG��t Build?",
    sub: "Stop consuming content. Build one real production-grade project G�� the right way G�� with structure and mentorship."
  },
  B: {
    id: 'B', // Outcome
    prefix: "Watched 100 Tutorials.",
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        >
          ...
          <div className="space-y-8 text-2xl md:text-4xl font-bold text-retro-teal leading-tight">
            ...
            >
              YouG��ve watched course after course.
            </motion.p>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              But when itG��s time to buildGǪ <span className="text-retro-salmon inline-block origin-center" style={{ animation: 'shake 0.8s cubic-bezier(.36,.07,.19,.97) both 1.5s' }}>you freeze.</span>
            </motion.div>
          </div>
        </motion.div>
        ...
        >
          ...
          >
            You start questioning if youG��re Gǣgood enough.Gǥ
          </motion.p>
          <motion.h3
            initial={{ opacity: 0, y: 10 }}
            whileInView={{ opacity: 1, y: 0 }}
  ...
  return (
    <section id="solution" className="py-20 md:py-32 bg-retro-teal text-white relative overflow-hidden">
      <div className="container mx-auto px-6 max-w-5xl text-center relative z-10">
        ...
        >
          Confidence DoesnG��t Come From Watching.<br />
  ...
  return (
    <section id="career-path" className="py-20 md:py-24 bg-white border-b border-retro-sage/10">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-retro-teal mb-6">Your First Tech Role Is Not a Dream. ItG��s a Process.</h2>
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-12 text-retro-teal/70 text-lg font-medium">
          <div className="flex items-center gap-2">
            <X className="text-retro-salmon" /> We donG��t promise shortcuts.
          </div>
...
const proofBlocks = [
  { figure: '8', unit: 'weeks', desc: 'Structured, paced curriculum G�� not a 40-hour dump' },
  ...
  return (
    <section id="why" className="py-16 md:py-32 bg-retro-bg relative">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-bold text-retro-teal">Why Ottobon?</h2>
...
const steps: Step[] = [
  ...
  },
  {
    ...
    description: "Senior mentors monitor telemetry, intervene when needed, and give the human feedback AI alone canG��t provide.",
    color: "bg-retro-salmon"
  }
];
        ...
        <div className="bg-white shadow-2xl p-8 md:p-10 w-full mx-auto rounded-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-10">
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <p className="text-[#244855]/70 leading-relaxed text-sm">
                A new coding challenge every 3G��5 minutes.
              </p>
            </div>
          ...
          <div className="flex justify-center">
            ...
            >
              LEARN MORE ABOUT THE Ottobon MODEL
        ...
        <motion.div style={{ x }} className="flex gap-8 px-6 md:px-24">
          ...
          {filtered.length === 0 && (
            <div className="w-[320px] md:w-[380px] h-[450px] bg-white/70 rounded-3xl shadow-inner border border-dashed border-retro-sage/60 flex items-center justify-center text-center px-6 text-retro-teal/70 font-semibold">
              No courses match Gǣ{searchTerm}Gǥ. Showing all trending courses instead.
            </div>
          )}
        </motion.div>
      </div>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 mb-4 border-b border-retro-bg pb-4">
        ...
        <div>
          <p className="font-bold text-retro-teal">Ottobon Assistant</p>
...
const testimonials = [
  ...
  {
    text: "Coming from a non-CS background in Jaipur, I thought getting into tech was impossible. This course made it practical G�� I got my first dev offer at a Gurugram startup.",
    author: "Vikram T.",
    role: "Software Engineer -+ Jaipur G�� Gurugram",
    color: "bg-[#f2f5ff]"
  },
  {
  ...
  return (
    <section id="reviews" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-6">
        ...
        {/* Trust-bridge: testimonials G�� action */}
        <motion.div
          initial={{ opacity: 0, y: 15 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <p className="text-retro-teal/60 text-base mb-4">Their journey started with a free trial G�� yours can too.</p>
          <button
            onClick={() => {
          ...
          >
            Explore courses G�� no signup needed GǦ
          </button>
        </motion.div>
      </div>
    </section>
      ...
      <div className="container mx-auto px-6 relative z-10 flex flex-col md:flex-row items-center justify-between gap-12">
        <div className="md:w-2/3">
          ...
          <p className="text-retro-cyan text-lg leading-relaxed max-w-xl">
            Are you an expert? Join the Ottobon faculty and shape the next generation of developers. Share your knowledge and earn while you teach.
          </p>
        </div>
...
const Pricing: React.FC<{ onEnroll: () => void }> = ({ onEnroll }) => {
  ...
  const proPrice = currency === 'INR' ? 'G�499' : '$29';
  const proPeriod = '/mo';
    ...
    <section id="pricing" className="py-16 md:py-32 bg-white relative overflow-hidden">
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12">
          ...
          <p className="text-retro-teal/70 text-lg mb-2">Why pay G�2,00,000 for a bootcamp?</p>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto items-center">
          ...
          <div className="p-8 rounded-3xl border border-retro-sage/30 bg-white">
            ...
            <div className="text-4xl font-bold text-retro-teal mb-2">{currency === 'INR' ? 'G�0' : '$0'}</div>
          ...
          >
            ...
            <p className="text-retro-cyan/60 text-xs font-mono mb-6">
              (Less than {currency === 'INR' ? 'G�17' : '$1'}/day)
            </p>
  ...
  return (
    <footer className="bg-retro-teal text-white py-12 border-t border-retro-sage/30">
      <div className="container mx-auto px-6 max-w-7xl flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <p className="text-white/60 text-sm">-� 2026 Ottobon. All rights reserved.</p>
...
const learningSteps = [
  ...
  },
  {
    ...
    title: 'Module Quiz',
    desc: 'Locked until steps 1G��3 are cleared. Proves full mastery.',
    color: 'bg-retro-sage',
              ...
              >
                ...
                {s.badge === 'locked' && (
                  <div className="mt-3 flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] font-bold uppercase tracking-wider text-retro-sage">locked until steps 1G��3 clear</span>
                  </div>
                )}
              </motion.div>
            ))}
...
const chatMessages = [
  { who: 'Mentor', text: 'Great commit, PM. SR G�� review the API PR before standup.', mentor: true },
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <div className="bg-retro-teal px-5 py-3 flex items-center justify-between">
              ...
              <span className="text-white/60 text-[11px] font-mono">Team Sprint G�� Week 4</span>
              <div className="flex -space-x-2">
                {teamMembers.map((m, i) => (
          ...
          >
            ...
            <ul className="space-y-4 mb-8">
              {[
                { icon: <Users size={18} className="text-retro-teal" />, text: '25-member cohort G�� structured like a real engineering team' },
...
function LandingPage() {
  ...
  return (
    ...
    >
      ...
      />
      <EmotionalHook />
      {/* <TurningPoint /> G�� removed: overlaps with EmotionalHook */}
      <TransformationSection />
      <WhoIsItFor />
      <LearningFlowSystem />
      <CohortSimulation />
      <HiringStrip />
      {/* <CareerPath /> G�� removed: repeats Transformation's message */}
      <Methodology />
      {/* <QuantifiedProof /> G�� removed: stats already in CurriculumStructure header */}
      <ValueProp />
      <AiStructure />
      ...
      {/* <Faculty /> */}
      {/* <MentorCTA onApplyTutor={handleApplyTutor} /> G�� removed from page */}
