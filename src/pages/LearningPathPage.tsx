      ...
      <div className="w-full max-w-3xl bg-[#0b1221] rounded-3xl border border-white/10 shadow-2xl p-6 md:p-10 space-y-8">
        ...
        {phase === "choose" && (
          <div className="space-y-6">
            <div>
              <p className="text-xs uppercase tracking-[0.3em] text-[#bf2f1f]">Ottobon onboarding</p>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-sm text-white/70">
                    Skip the quiz and jump right into the classic academic narration used across Ottobon.
                  </p>
                </div>
