  ...
  return (
    <div className="animate-fade-in relative z-0 pb-16">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_280px] gap-8">
        <div className="flex flex-col gap-8">
          <section>
            <h2 className="text-lg font-bold text-retro-teal mb-4 flex items-center gap-2">
              <i className="fas fa-users text-retro-teal"></i> Active Cohort
            </h2>
            <div className="bg-white rounded-xl shadow-sm p-6 w-full border border-retro-sage/20">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-8">
                <div className="bg-gray-50/50 p-5 rounded-2xl border border-retro-sage/20 relative">
                  <div className="flex justify-between items-center mb-4">
                    <h4 className="text-sm font-bold text-gray-700 flex items-center gap-2">
                      <i className="fas fa-project-diagram text-retro-salmon/80"></i> Current Project
                    </h4>
                    <span className="text-[0.65rem] font-bold px-2 py-0.5 rounded bg-retro-bg text-retro-salmon uppercase border border-retro-salmon/20">Phase 2</span>
                  </div>
                  ...
                  <div className="flex justify-between items-end">
                    <div className="flex flex-col gap-1.5 w-2/3">
                      ...
                      <div className="w-full bg-gray-200 rounded-full h-1.5 overflow-hidden">
                        <div className="h-full bg-retro-teal rounded-full" style={{ width: '45%' }}></div>
                      </div>
                    </div>
                    <button className="text-[0.7rem] font-bold text-retro-salmon bg-white border border-retro-salmon/30 px-3 py-1.5 rounded-lg hover:bg-retro-salmon hover:text-white transition-all shadow-sm">
                      Details
                    </button>
                  </div>
                </div>
                ...
                <div className="bg-white p-5 rounded-2xl border border-gray-100 flex flex-col justify-between">
                  ...
                  <button className="w-full bg-retro-teal text-white text-sm font-bold py-2.5 rounded-xl hover:brightness-110 transition-all shadow-md flex items-center justify-center gap-2">
              ...
              <div className="flex flex-wrap gap-3 mt-4 pt-4 border-t border-border-soft">
                <button className="bg-retro-salmon text-white text-sm font-bold px-6 py-2.5 rounded-xl hover:shadow-lg transition-all shadow-md">
                  Go to Course
                </button>
                <button className="bg-white border border-retro-sage/20 text-retro-teal text-sm font-bold px-6 py-2.5 rounded-xl hover:bg-gray-50 transition-all flex items-center gap-2">
          ...
          <section>
            <h2 className="text-lg font-bold text-retro-teal mb-4 flex items-center gap-2">
              <i className="fas fa-history text-retro-teal"></i> Previous Cohort
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="bg-white rounded-xl shadow-sm p-5 border border-retro-sage/20 flex flex-col justify-between group cursor-pointer hover:border-retro-salmon/30 transition-all grayscale-[0.6] hover:grayscale-0">
                <div>
                  <h3 className="font-bold text-[1rem] flex items-center gap-2 mb-1 group-hover:text-retro-salmon transition-colors">
                    Intro to HTML/CSS
                  </h3>
        ...
        <div className="flex flex-col gap-8">
          <section className="bg-white rounded-xl shadow-sm p-6 border border-retro-sage/20">
            <h3 className="text-[1rem] font-bold mb-4 flex items-center gap-2">
              <i className="fas fa-calendar-day text-retro-salmon opacity-70"></i> Upcoming Sessions
            </h3>
            <div className="flex flex-col gap-3">
              <div className="p-3 bg-retro-bg/30 rounded-xl border-l-4 border-retro-salmon flex flex-col gap-1 group cursor-pointer hover:bg-retro-bg/50 transition-all">
                <span className="text-[0.65rem] font-bold text-orange-600 mb-1">Today, 2:00 PM</span>
                <p className="text-[0.75rem] font-extrabold text-retro-teal leading-tight group-hover:text-orange-700">Project Review with Mentor</p>
              ...
              <div className="p-3 bg-gray-50/80 rounded-xl border-l-4 border-gray-300 flex flex-col gap-1 group cursor-pointer hover:bg-gray-100 transition-all opacity-80 hover:opacity-100">
                ...
                <p className="text-[0.75rem] font-extrabold text-retro-teal leading-tight group-hover:text-retro-teal">Cloud Deployment Basics</p>
              </div>
            </div>
            <button className="w-full text-xs font-bold text-retro-salmon mt-6 py-2 border border-retro-salmon/20 rounded-lg hover:bg-retro-salmon hover:text-white transition-all">
              View Calendar
            </button>
          </section>
          ...
          <section className="bg-white rounded-xl shadow-sm p-6 border border-retro-sage/20">
            ...
            <div className="flex flex-col items-center pt-2">
              <div className="relative mb-3">
                ...
                <img src={avatarImage} className="w-[80px] h-[80px] rounded-full border-4 border-retro-bg shadow-inner object-cover" />
              </div>
              <h4 className="font-bold text-[0.95rem]">Kenjiro Tanaka</h4>
              <p className="text-[0.65rem] font-bold text-retro-salmon uppercase tracking-widest mt-0.5">Ranked #1</p>
              <div className="w-full h-px bg-gray-100 my-4"></div>
              <div className="w-full space-y-3">
                <div className="flex justify-between text-xs font-bold">
                  <span className="text-gray-400">Total Points</span>
                  <span className="text-retro-teal">1,420</span>
                </div>
                <div className="flex justify-between text-xs font-bold">
                  <span className="text-gray-400">Streak</span>
                  <span className="text-retro-salmon">45 Days</span>
                </div>
              </div>
            </div>
          </section>
