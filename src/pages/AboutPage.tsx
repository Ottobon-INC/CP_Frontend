    ...
    >
      <section className="relative overflow-hidden rounded-3xl border border-slate-100 bg-gradient-to-br from-emerald-50 via-white to-cyan-50 p-8 sm:p-12">
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="space-y-4">
            <h1 className="text-4xl font-bold text-slate-900 sm:text-5xl">{content?.title ?? "About Ottobon"}</h1>
            <p className="text-lg text-slate-600">
              {content?.subtitle ?? "Ottobon is a learner-obsessed platform blending AI copilots with human mentorship."}
            </p>
          </div>
      ...
      <section className="space-y-6">
        <div className="flex items-center gap-3 text-slate-600">
          ...
          <h2 className="text-xl font-semibold text-slate-900">Why learners choose Ottobon</h2>
        </div>
